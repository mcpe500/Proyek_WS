...
exports.addWorkoutToExercisePlanSchemaJoi = exports.exercisePlanDetailsSchemaJoi = exports.createUserPlanSchemaJoi = void 0;
const _1 = require(".");
...
exports.createUserPlanSchemaJoi = _1.JoiExtended.object({
    name: _1.JoiExtended.string().required().messages({
        "string.base": "Name must be a string",
        "any.required": "Name is a required field",
    }),
    description: _1.JoiExtended.string().required().messages({
        "string.base": "Description must be a string",
        "any.required": "Description is a required field",
    }),
    goals: _1.JoiExtended.array()
        .items(_1.JoiExtended.string()
    ...
    durationInWeeks: _1.JoiExtended.number()
        .integer()
        .positive()
        .required()
        .messages({
    ...
    frequencyPerWeek: _1.JoiExtended.number()
        .integer()
        .positive()
        .required()
        .messages({
    ...
    restDaysPerWeek: _1.JoiExtended.number()
        .integer()
        .positive()
        .required()
        .messages({
    ...
    intensity: _1.JoiExtended.number().required().messages({
        "number.base": "Intensity must be a number",
        "any.required": "Intensity is a required field",
    }),
    exercises: _1.JoiExtended.array()
        .items(_1.JoiExtended.object({
        name: _1.JoiExtended.string().required().messages({
        ...
        sets: _1.JoiExtended.number().integer().positive().required().messages({
        ...
        repetitions: _1.JoiExtended.number()
            .integer()
            .positive()
            .required()
            .messages({
        ...
        restBetweenSetsInSeconds: _1.JoiExtended.number()
            .integer()
            .positive()
            .required()
            .messages({
        ...
        equipmentRequired: _1.JoiExtended.array()
            .items(_1.JoiExtended.object({
            name: _1.JoiExtended.string().required().messages({
    ...
    nutritionPlan: _1.JoiExtended.object().optional(),
});
exports.exercisePlanDetailsSchemaJoi = _1.JoiExtended.object({});
exports.addWorkoutToExercisePlanSchemaJoi = _1.JoiExtended.object({});
