...
paths["/api/v1/auth/refresh-token"] = newRefreshToken;
...
paths["/api/v1/pricing/packages"] = getAllPricing;
paths["/api/v1/users/api-key"] = getUserAPIKey;
paths["/api/v1/users/api-key/reset"] = resetUserAPIKey;
...
paths["/api/v1/exercises/goals/{title}"] = getGoalByTitle;
paths["/api/v1/users/plans/{id}/cancel"] = cancelPlanByUser;

paths["/api/v1/admin/users"] = getAllUser;
paths["/api/v1/admin/dashboard"] = adminDashboard; // GET
paths["/api/v1/admin/exercises"] = postExcercise;
paths["/api/v1/admin/users/{userID}"] = getAndDeleteUserProfile; // GET and DELETE
paths["/api/v1/admin/users/{userID}/profile-picture"] = getUserProfilePicture; // GET and DELETE
paths["/api/v1/admin/users/{userID}/packages"] = getAndPostAndDeletePacket; // GET and POST and DELETE
paths["/api/v1/admin/users/{userID}/topup"] = topupFromAdmin;

paths["/api/v1/super-admin/packages"] = postPaket;
paths["/api/v1/super-admin/packages/{id}"] = putAndDeletePaket;
paths["/api/v1/super-admin/users/{userID}/promote"] = promoteAdmin;
